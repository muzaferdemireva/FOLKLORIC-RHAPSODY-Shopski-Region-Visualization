...
function preload() {
  video = createVideo("shopska.mp4", () => { video.hide(); videoLoaded = true; });
  img = loadImage("shopska-colours.png", () => imgLoaded = true);
  icon = loadImage("shopska-icon.png", () => iconLoaded = true);
...
function setup() {
  ...
  document.title = "Thracian Region | Folkloric Rhapsody"; 
